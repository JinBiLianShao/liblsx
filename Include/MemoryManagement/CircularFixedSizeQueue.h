 ...
 * @brief 循环固定大小内存块队列类
 * @details 定义了 LSX_LIB::Memory 命名空间下的 CircularFixedSizeQueue 类，
 ...
 * LSX_LIB::Memory::CircularFixedSizeQueue queue(10, 5);
 *
 * // 生产者线程
...
#ifndef LSX_LIB_MEMORY_CIRCULAR_FIXED_SIZE_QUEUE_H
#define LSX_LIB_MEMORY_CIRCULAR_FIXED_SIZE_QUEUE_H
#pragma once
// 包含全局错误锁头文件
...
#endif // LSX_LIB_MEMORY_CIRCULAR_FIXED_SIZE_QUEUE_H
